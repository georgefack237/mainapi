...
class Shownfc extends Component

{
    ...
    {
        $this->profile = nfcprofile::where('id', $slug)->with(['pageviews', 'contacts'])->first();
    ...
    public function render()
    {
        ...
        return view('livewire.nfc.shownfc', compact(['activities', 'contacts']));
    }
}
