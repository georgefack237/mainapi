                            ...
                            <ul class="list-group list-group-flush text-sm">
                                ...
                                <li class="list-group-item bg-transparent">
                                    <div class="row">
                                        ...
                                        <span class="col-9"><a href="{{ $profile->facebook }}">{{ $profile->website }}</a></span>
                                    </div>
                                </li>
                                <li class="list-group-item bg-transparent">
                                    <div class="row">
                                        <span class="font-weight-bold col-3">Lien Facebook:</span>
                                        <span class="col-9"><a href="{{ $profile->facebook }}">{{ $profile->facebook }}</a></span>
                                    </div>
                                </li>
                                <li class="list-group-item bg-transparent">
                                    <div class="row">
                                        <span class="font-weight-bold col-3">Lien LinkedIn:</span>
                                        <span class="col-9"><a href="{{ $profile->linkedin }}">{{ $profile->linkedin }}</a></span>
                                    </div>
                                </li>
                                <li class="list-group-item bg-transparent">
                                    <div class="row">
                                        <span class="font-weight-bold col-3">Lien Twitter:</span>
                                        <span class="col-9"><a href="{{ $profile->twitter }}">{{ $profile->twitter }}</a></span>
                                    </div>
                                </li>
                            </ul>
                        </div>
