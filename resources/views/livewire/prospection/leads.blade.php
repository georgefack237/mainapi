        ...
        <div class="row">
                ...
                <div class="py-1 px-3 mt-2 mb-3 rounded bg-secondary d-none d-lg-block">
                    <div class="row">
                        ...
                        <div class="col-2 media align-items-center">
                            <span class="mb-0 font-weight-bold text-muted text-sm">Leads</span>
                        </div>
                                ...
                                <div class="col-2 d-none d-lg-flex align-items-center justify-content-between">
                                    ...
                                    <span class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            ...
                                            <div class="px-3 py-2">
                                                <h6 class="text-xs text-muted m-0">Convertir en prospect</h6>
                                            </div>
                                            <a class="dropdown-item" href="#"
                                                wire:click='makeProspect({{ $item->id }})'><i
                                                    class="fa fa-user-plus text-warning mr-3"></i>Prospect (Chaud)</a>
                                            <a class="dropdown-item" href="#"
                                                wire:click='makeWarmProspect({{ $item->id }})'><i
                                                    class="fas fa-user-plus text-warning mr-3"></i>Prospect (Tiede)</a>
                                            <div class="dropdown-divider"></div>
                                            <div class="px-3 py-2">
                                                <h6 class="text-xs text-muted m-0">Convertir en opportunité</h6>
                                            </div>
                                            <a class="dropdown-item" href="#"
                                ...
                                <div class="d-lg-none">
                                    ...
                                    @else
                                        ...
                                        <span class="dropdown ml-auto">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                {{-- <a class="dropdown-item" href="tel:{{ $item->phone }}"><i
                                                        class="fas fa-phone text-primary mr-3"></i>Appeler</a>
                                                <a class="dropdown-item" href="mailto:{{ $item->email }}"><i
                                                        class="fas fa-paper-plane text-info mr-3"></i>Envoyer un
                                                    mail</a> --}}
            ...
            <div class="col-lg-3">
                <div class="filters mt--7 bg-white rounded overflow-hidden shadow-lg">
                    ...
                    <div class="px-2">
                        <span class="text-muted text-xs font-weight-700 d-block mb-2">Leads</span>
                        <div class="d-flex">
                ...
                <div class="rounded bg-primary shadow-lg mt-2 px-4 py-2">
                    <h2 class="text-white h3 mb-0">{{ $leads->count() }} Lead(s)</h2>
                </div>
            </div>
            {{-- Filters Section end --}}
