            ...
            <div class="header-body">
                <div class="align-items-center py-3">
                    <div class="d-flex justify-content-between">
                        <h2 class="mb-4 h1">Opportunités</h2>
                    </div>
        ...
        <div class="row">
                ...
                <div class="py-1 px-3 mt-2 mb-3 rounded bg-secondary d-none d-lg-block">
                    <div class="row">
                        ...
                        <div class="col-2 media align-items-center">
                            <span class="mb-0 font-weight-bold text-muted text-sm">Opportunité</span>
                        </div>
                                ...
                                <div class="col-2 d-none d-lg-flex align-items-center justify-content-between">
                                    ...
                                    <span class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            ...
                                            <div class="px-3 py-2">
                                                <h6 class="text-xs text-muted m-0">Status de l'opportunité</h6>
                                            </div>
                                            <a class="dropdown-item" href="#"
                                                wire:click='makeOpportunityLost({{ $item->id }})'><i
                                                    class="fa fa-trash-can text-danger mr-3"></i>Perdu</a>
                                            <a class="dropdown-item" href="#"
                                                wire:click='recordSale({{ $item->id }})'><i
                                                    class="bi bi-cart-check-fill text-success mr-3"></i>Validé achat</a>
                                        </div>
                                    </span>
                                </div>
                            </div>
            ...
            <div class="col-lg-3">
                <div class="filters mt--7 bg-white rounded overflow-hidden shadow-lg">
                    ...
                    <div class="px-2">
                        <span class="text-muted text-xs font-weight-700 d-block mb-2">Opportunités</span>
                        <div class="d-flex">
                ...
                <div class="rounded bg-primary shadow-lg mt-2 px-4 py-2">
                    <h2 class="text-white h3 mb-0">{{ $leads->count() }} Opportunité(s)</h2>
                </div>
            </div>
            {{-- Filters Section end --}}
