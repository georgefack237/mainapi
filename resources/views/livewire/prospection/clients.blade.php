        ...
        <div class="row">
                ...
                <div class="py-1 px-3 mt-2 mb-3 rounded bg-secondary d-none d-lg-block">
                    <div class="row">
                        ...
                        <div class="col-2 media align-items-center">
                            <span class="mb-0 font-weight-bold text-muted text-sm">Coût d'acquisition</span>
                        </div>
                        <div class="col-4 col-lg-2 media d-none d-lg-inline text-right">
                        ...
                        <div class="d-flex ali d-lg-block rounded">
                            <div class="row">
                                ...
                                <div class="col-lg-2 align-items-center d-none d-lg-block">
                                    <small
                                        class="mb-0 d-block font-weight-700 text-sm text-capitalize">XAF {{ $item->appointments->sum('cost') }}</small>
                                </div>
                                <div class="col-2 d-none d-lg-inline text-right">
            ...
            <div class="col-lg-3">
                ...
                <div class="rounded bg-primary shadow-lg mt-2 px-4 py-2">
                    <h2 class="text-white h3 mb-0">{{ $leads->count() }} Client(s)</h2>
                </div>
            </div>
            {{-- Filters Section end --}}
