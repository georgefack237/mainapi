            ...
            <div class="col-lg-9">
                <div class="align-items-center mt-4 py-3">
                    ...
                    <div class="d-lg-flex justify-content-between mt-4">
                        ...
                        <div class="mt-3 mt-lg-0 d-flex justify-content-between" role="group" aria-label="Basic example">
                            <button type="button" id="this-day" class="btn btn-sm btn-secondary badge-info shadow-none" onclick="thisDay()" wire:click='thisDay()'>
                                Aujourd'hui
                            </button>
                            <button type="button" id="this-week" class="btn btn-sm btn-secondary badge-info shadow-none" onclick="thisWeek()" wire:click='thisWeek()'>
                                Cette semaine
                            </button>
                            <button type="button" id="this-month" class="btn btn-sm btn-secondary badge-info shadow-none" onclick="thisMonth()" wire:click='thisMonth()'>
                                Ce mois
                            </button>
                            <button type="button" id="this-month" class="btn btn-sm btn-secondary badge-info shadow-none" onclick="thisYear()" wire:click='thisYear()'>
                                Cette année
                            </button>
                        </div>
                        <a href="#" class="btn btn-sm btn-success shadow-none d-none d-lg-inline ml-4" onclick="event.preventDefault();
                ...
                <div class="nfc-profile-item py-1 px-3 my-2 border-bottom border-top d-none d-lg-block">
                    <div class="row">
                        ...
                        <div class="col-1 media align-items-center justify-content-center">
                            <span class="mb-0 font-weight-bold text-muted text-sm">Alerte</span>
                        </div>
                        ...
                        <div class="nfc-profile-item py-2 px-3 my-2 border-bottom">
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="media align-items-center">
                                        <div class="media-body">
                                            <span class="name mb-0 text-sm font-weight-bold">{{ $activity->created_at->format('D d M Y') }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-2 media align-items-center">
                                    <small class="mb-0">{{ $activity->country_name }}, {{ $activity->city_name }}</small>
                                </div>
                                <div class="col-lg-4 media align-items-center">
                                    <small class="mb-0 nfc-link-text-2">{{ $activity->user_agent }}</small>
                                    <div class="ml-auto">
                                        @if($activity->warning==true) <i class="fa fa-circle-exclamation text-danger mx-auto"></i>@endif
                                    </div>
                                </div>
                                <div class="col-lg-1 media align-items-center justify-content-center d-none d-lg-block">
                                    @if($activity->warning==true) <i class="fa fa-circle-exclamation text-danger mx-auto"></i>@endif
                                </div>
                                <div class="col-lg-3 media align-items-center">
