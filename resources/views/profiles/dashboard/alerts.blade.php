                ...
                <div class="col-8 col-lg-5">
                    <div class="media align-items-center">
                        <div class="media-body">
                            <span class="name mb-0 font-weight-bold text-muted text-sm">Description</span>
                        </div>
                    </div>
                </div>
                <div class="col-3 media align-items-center">
                    <span class="mb-0 font-weight-bold text-muted text-sm">Date</span>
                </div>
                <div class="col-4 col-lg-4 media d-none d-lg-inline">
