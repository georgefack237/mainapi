        ...
        <div class="modal-dialog modal-sm navbar-expand-xs mobile-menu">
            <div class="modal-content">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ 'admin/nfcprofiles' == request()->path() ? 'active' : '' }}"
                            href="{{ url('/admin/nfcprofiles') }}">
                            <i class="fa fa-users text-success"></i>
                            <span class="nav-link-text">Profiles</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ 'admin/contacts' == request()->path() ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ 'admin/activites' == request()->path() ? 'active' : '' }}"
                            href="{{ url('/admin/activites') }}">
                            <i class="fas fa-chart-line text-success"></i>
                            <span class="nav-link-text">Suivi d'Activités</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ 'admin/chats' == request()->path() ? 'active' : '' }}"
                            href="{{ url('/admin/chats') }}">
                            ...
                            <li class="nav-item dropdown mt-4">
                                <a class="pr-0" href="#" role="button" data-toggle="dropdown"
                                    ...
                                    <div class="d-flex align-items-center text-center border p-2 bg-lighter" style="border-radius: 20px;">
                                        <span class="avatar avatar-md rounded-circle">
                                            {{-- <img src="{{ Auth::user()->image }}" alt="{{ Auth::user()->lastname }}"> --}}
