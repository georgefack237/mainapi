            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{'partner' == request()->path() ? 'active' : ''}}" href="{{ url('/partner') }}">
                                <i class="fa fa-display text-success"></i>
                                <span class="nav-link-text">Dashboard</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{'partner/clients' == request()->path() ? 'active' : ''}}" href="{{ url('/partner/clients') }}">
                                <i class="fa fa-users text-success"></i>
                                <span class="nav-link-text">Clients</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{'partner/settings' == request()->path() ? 'active' : ''}}" href="{{ url('/partner/settings') }}">
